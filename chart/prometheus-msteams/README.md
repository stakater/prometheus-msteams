...
# Use Microsoft Teams Workflow connector webhook URLs (new format)
- bar: https://prod-00.westeurope.logic.azure.com/workflows/xxxx/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=xxxx
# in alertmanager, this will be used as http://prometheus-msteams:2000/foo
- foo: https://prod-00.westeurope.logic.azure.com/workflows/xxxx/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=xxxx
...
connectorsWithCustomTemplates:
  - request_path: /alert2
    # Use Microsoft Teams Workflow connector webhook URL (new format with query parameters)
    webhook_url: https://prod-00.westeurope.logic.azure.com/workflows/xxxx/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=xxxx
