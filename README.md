...
A lightweight Go Web Server that receives __POST__ alert messages from __Prometheus Alert Manager__ and sends it to a __Microsoft Teams Channel__ using an incoming webhook url. How light? See the [docker image](https://ghcr.io/stakater/prometheus-msteams)!
...
This project was inspired from [prometheus-msteams/prometheus-msteams](https://github.com/prometheus-msteams/prometheus-msteams), which has some very basic [Adaptive Card](https://adaptivecards.microsoft.com/) support.
...
docker run -d -p 2000:2000 \
    ...
    ghcr.io/stakater/prometheus-msteams
```
...
- name: 'prometheus-msteams'
  webhook_configs:
  - send_resolved: true
    url: 'http://localhost:2000/_dynamicwebhook/default***.api.powerplatform.com:443/powerautomate/automations/direct/workflows/xxx' # the prometheus-msteams proxy + "/_dynamicwebhook/" + webhook url (without prefix "https://")
```
...
- name: 'prometheus-msteams'
  ...
  - send_resolved: true
    http_Config:
      authorization:
        type: 'webhook'
        credentials: 'default***.api.powerplatform.com:443/powerautomate/automations/direct/workflows/xxx' # webhook url (without prefix "https://")
...
```yaml
connectors:
- high_priority_channel: "https://default***.api.powerplatform.com:443/powerautomate/automations/direct/workflows/bbb"
- low_priority_channel: "https://default***.api.powerplatform.com:443/powerautomate/automations/direct/workflows/ccc"
```
...
docker run -d -p 2000:2000 \
    ...
    ghcr.io/stakater/prometheus-msteams:v1.5.1
```
...
docker run -d -p 2000:2000 \
    --name="promteams" \
    -e TEAMS_INCOMING_WEBHOOK_URL="https://default***.api.powerplatform.com:443/powerautomate/automations/direct/workflows/xxx" \
