...
type Converter interface {
	Convert(context.Context, webhook.Message) (adaptivecards.WorkflowConnectorCard, error)
}
...
func NewCreatorLoggingMiddleware(l *utility.Logger, n Converter) Converter {
	return loggingMiddleware{l, n}
}

func (l loggingMiddleware) Convert(ctx context.Context, a webhook.Message) (c adaptivecards.WorkflowConnectorCard, err error) {
